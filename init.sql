...
CREATE INDEX idx_posts_content_fts ON posts USING GIN ((title || ' ' || content) to_tsvector('english'));
...
VALUES ('admin', '$2a$10$EqKcp1WFKVQISheLRRXOVOqH5x9qzDJ0YJRAmyV5H5GCrUoeWwJqq', TRUE)
